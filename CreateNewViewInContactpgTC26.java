...
public class CreateNewViewInContactpgTC26 {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		enterViewName.sendKeys("VIEw Name");
		Thread.sleep(2000);

		WebElement enterViewUniqueName= driver.findElement(By.id("devname"));
		enterViewUniqueName.sendKeys("");
		Thread.sleep(2000);
