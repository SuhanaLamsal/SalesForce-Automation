...
public class RecentlyCreatedContactTC27 {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		WebElement selectRecentlyCreated= driver.findElement(By.xpath("//*[@id=\"hotlist_mode\"]/option[1]"));
		selectRecentlyCreated.click();
		Thread.sleep(2000);
